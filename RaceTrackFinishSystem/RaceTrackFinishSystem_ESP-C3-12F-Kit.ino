/*
  ...
  Board: ESP-C3-12F-Kit (Arduino IDE)
...
// Pin map for ESP-C3-12F-Kit in this 3-lane build:
// - Lane IR: GPIO 0, 1, 2
// - Lane 1 stepper: GPIO 3, 4, 5, 6
// - Lane 2 stepper: GPIO 7, 8, 9, 10
// - Lane 3 stepper: GPIO 18, 19, 20, 21
const uint8_t IR_PINS[LANE_COUNT] = {0, 1, 2};

// Optional reset button (to GND), INPUT_PULLUP enabled.
// Disabled in this ESP-C3 mapping to preserve GPIOs for the third stepper.
const bool ENABLE_RESET_BUTTON = false;
const uint8_t RESET_BUTTON_PIN = 255;
...
// Lane 1 stepper pins
const uint8_t L1_IN1 = 3;
const uint8_t L1_IN2 = 4;
const uint8_t L1_IN3 = 5;
const uint8_t L1_IN4 = 6;

// Lane 2 stepper pins
const uint8_t L2_IN1 = 7;
const uint8_t L2_IN2 = 8;
const uint8_t L2_IN3 = 9;
const uint8_t L2_IN4 = 10;

// Lane 3 stepper pins
const uint8_t L3_IN1 = 18;
const uint8_t L3_IN2 = 19;
const uint8_t L3_IN3 = 20;
